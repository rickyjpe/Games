...
class DoodleJump:
    def __init__(self):
        ...
        self.green = pygame.image.load("alien/green.png").convert_alpha()
        pygame.font.init()
        self.score = 0
        self.font = pygame.font.SysFont("Arial", 25)
        self.blue = pygame.image.load("alien/blue.png").convert_alpha()
        self.red = pygame.image.load("alien/red.png").convert_alpha()
        self.red_1 = pygame.image.load("alien/red_1.png").convert_alpha()
        self.playerRight = pygame.image.load("alien/right.png").convert_alpha()
        self.playerRight_1 = pygame.image.load("alien/right_1.png").convert_alpha()
        self.playerLeft = pygame.image.load("alien/left.png").convert_alpha()
        self.playerLeft_1 = pygame.image.load("alien/left_1.png").convert_alpha()
        self.spring = pygame.image.load("alien/spring.png").convert_alpha()
        self.spring_1 = pygame.image.load("alien/spring_1.png").convert_alpha()
        self.direction = 0
        self.playerx = 400
        self.playery = 400
